...
@InputType()
class MonthlySummaryCreateNestedManyWithoutHostelsInput {
...
export { MonthlySummaryCreateNestedManyWithoutHostelsInput as MonthlySummaryCreateNestedManyWithoutHostelsInput };
